...
public class ViewPodcastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId(R.id.menuPodcast);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.menuMusic:
                        intent = new Intent(ViewPodcastActivity.this, ViewMusicActivity.class);
                    ...
                    case R.id.menuVideo:
                        intent = new Intent(ViewPodcastActivity.this, ViewVideoActivity.class);
                        startActivity(intent);
                        overridePendingTransition(0, 0);
                        finish();
                        break;
...
//            startActivity(new Intent(this, .class));
        ...
        if (item.getItemId() == R.id.menuSettings) {
            startActivity(new Intent(ViewPodcastActivity.this, SettingsActivity.class));
        }
